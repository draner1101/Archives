...
<body style="background-color: #EEE; margin-top: -20px;">
    ...
    <div class="contenu">
        ...
        <div style="width: 49%; padding-bottom: 50px; float: left;">
            <div class='demande'>
                ...
                ?>  
                    <label>Nom</label>
                    <input  readonly class="formulaire gauche"type="text" name="nom" placeholder="Nom" value="<?=$personne["nom"]?>">
                    <label>Prénom</label>
                    <input  readonly class="formulaire gauche"type="text" id="prenom" name="prenom" placeholder="Prénom" value="<?=$personne["prenom"]?>"><br><br>
                    <label>Sexe</label><br>
                    <?php
                    ...
                    <input readonly placeholder="Date de naissance" class="formulaire gauche" type="text" name="date_naissance" value="<?=$personne["date_naissance"]?>">
                    <label>Numéro de téléphone</label>
                    <input  readonly class="formulaire gauche" type="text" id="phone" name="no_tel" placeholder="Numéro de téléphone" value="<?=$personne["no_tel"]?>">
                    <label>Poste téléphonique</label>
                    <input  readonly class="formulaire gauche" type="text" id="poste" name="posteTelephonique" placeholder="Poste téléphonique" value="<?=$personne["posteTelephonique"]?>">
                    <label>Courriel</label>
                    <input  readonly class="formulaire gauche" type="email" name="courriel" placeholder="Courriel"value="<?=$personne["courriel"]?>">
                    <label>Adresse civique</label>
                    <input  readonly class="formulaire gauche" type="text" name="rue" placeholder="Adresse civique" value="<?=$personne["rue"]?>">
                    <label>Ville</label>
                    <input  readonly class="formulaire gauche" type="text" name="ville" placeholder="Ville" value="<?=$personne["ville"]?>">
                    <label>Province</label>
                    <input  readonly class="formulaire gauche" type="text" name="province" placeholder="Province" value="<?=$personne["province"]?>">
                    <label>Code postal</label>
                    <input  readonly class="formulaire gauche" type="text" id="code" name="code_postal" placeholder="Code postal" value="<?=$personne["code_postal"]?>">
                <?php
                    }
                    ...
                    <input  readonly class="formulaire gauche" type="text" name="no_embauche" placeholder="No d'embauche" value="<?=$info["no_embauche"]?>">
                    <label>Type</label>
                    ...
                    <textarea  readonly class="formulaire gauche" type="text" name="note" placeholder="Remarques" rows="10" cols="50"><?=$info["note"]?></textarea>                           
                        ...
                        case 'personnels':
                            ?>
                    <label>Rôle</label>
                    <input  readonly class="formulaire gauche" type="text" name="role" placeholder="Rôle" value="<?=$info["role"]?>">
                    <label>No d'embauche(s)</label>
                    <input  readonly class="formulaire gauche" type="text" name="no_embauches" placeholder="No d'embauche(s)" value="<?=$info["no_embauches"]?>">
                    <label>Date d'embauche</label>
                    <input readonly placeholder="Date d'embauche" class="formulaire gauche" type="text" name="dateEmbauche" value="<?=$info["dateEmbauche"]?>">
                    <label>Date de fin</label>
                    <input readonly placeholder="Date de fin" class="formulaire gauche" type="text" name="dateFin" value="<?=$info["dateFin"]?>">
                            <?php
                            break;
                        case 'equipes':
                            ?>
                    <label>Nom</label>
                    <input readonly class="formulaire gauche"type="text" name="nom" placeholder="Nom" value="<?=$info["nom"]?>">
                    <label>Sexe</label><br>
                     <?php
                    //Vérifie le sexe de la personne et coche la bonne option
                    if($info["sexe"] == "M"){
                    ...
                    ?>
                    <label>Saison</label>
                    <input  readonly class="formulaire gauche"type="text" name="saison" placeholder="Saison" value="<?=$info["saison"]?>">
                    <label>Photo d'équipe</label>
                    <input  readonly class="formulaire gauche" type="text" name="photo_equipe" placeholder="Photo équipe" value="<?=$info["photo_equipe"]?>">
                    <?php
        ...
        <div style="width: 49%; padding-bottom: 50px; float: left;"> 
            <div class='demande'>
                ...
                ?>
                    ...
                    <label>Nom</label>
                    <span><input type="checkbox" name="cNom" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite"type="text" name="nom" placeholder="Nom" value="<?=$personneDroite["nom"]?>"></span>
                    <label>Prénom</label>
                    <span><input type="checkbox" name="cPrenom" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite"type="text" name="prenom" placeholder="Prénom" value="<?=$personneDroite["prenom"]?>"><br><br></span>
                    <label>Sexe</label><br>
                    <?php
                    //Vérifie le sexe de la personne et coche la bonne option
                    ...
                    <label>Numéro de  téléphone</label>
                    <span><input type="checkbox" name="cNo_tel" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" id="phone" name="no_tel" placeholder="Numéro de téléphone" value="<?=$personneDroite["no_tel"]?>"></span>
                    <label>Poste téléphonique</label>
                    <span><input type="checkbox" name="cPosteTelephonique" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" id="poste" name="posteTelephonique" placeholder="Poste téléphonique" value="<?=$personneDroite["posteTelephonique"]?>"></span>
                    <label>Courriel</label>
                    <span><input type="checkbox" name="cCourriel" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="email" name="courriel" placeholder="Courriel"value="<?=$personneDroite["courriel"]?>"></span>
                    <label>Adresse</label>
                    <span><input type="checkbox" name="cRue" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="rue" placeholder="Adresse civique" value="<?=$personneDroite["rue"]?>"></span>
                    <label>Ville</label>
                    <span><input type="checkbox" name="cVille" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="ville" placeholder="Ville" value="<?=$personneDroite["ville"]?>"></span>
                    <label>Province</label>
                    <span><input type="checkbox" name="cProvince" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="province" placeholder="Province" value="<?=$personneDroite["province"]?>"></span>
                    <label>Code postal</label>
                    <span><input type="checkbox" name="cCode_postal" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" id="code" name="code_postal" placeholder="Code postal" value="<?=$personneDroite["code_postal"]?>"></span>
                <?php
                    }
                    ...
                    <label>No d'embauche</label>
                    <span><input type="checkbox" name="cNo_embauche" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="no_embauche" placeholder="No d'embauche" value="<?=$tableDroite["no_embauche"]?>"></span>
                    <label>Type</label>
                    ...
                    <label>Rôle</label>
                    <span><input type="checkbox" name="cRole" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="role" placeholder="Rôle" value="<?=$tableDroite["role"]?>"></span>
                    <label>No d'embauche(s)</label>
                    <span><input type="checkbox" name="cNo_embauches" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="no_embauches" placeholder="No d'embauche(s)" value="<?=$tableDroite["no_embauches"]?>"></span>
                    <label>Date d'embauche</label>
                    <span><input type="checkbox" name="cDateEmbauche" style="padding: 10px;"><input style="width: 92%;" placeholder="Date d'embauche" class="formulaire droite" autocomplete="off" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="dateEmbauche" value="<?=$tableDroite["dateEmbauche"]?>"></span>
                    <label>Date de fin</label>
                    <span><input type="checkbox" name="cDateFin" style="padding: 10px;"><input style="width: 92%;" placeholder="Date de fin" class="formulaire droite" autocomplete="off" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="dateFin" value="<?=$tableDroite["dateFin"]?>"></span>
                            <?php
                            break;
                        case 'equipes':
                    ...
                    <label>Nom</label>
                    <span><input type="checkbox" name="cnom" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite"type="text" name="nom" placeholder="Nom" value="<?=$tableDroite["nom"]?>"></span>
                    <label>Sexe</label><br>
                     <?php
                    //Vérifie le sexe de la personne et coche la bonne option
                    ...
                    ?>
                   <label>Saison</label>
                   <span><input type="checkbox" name="cSaison" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite"type="text" name="saison" placeholder="Saison" value="<?=$tableDroite["saison"]?>">
                   <label>Photo d'équipe</label>
                   <span><input type="checkbox" name="cPhoto_equipe" style="padding: 10px;"><input style="width: 92%;" class="formulaire droite" type="text" name="photo_equipe" placeholder="Photo équipe" value="<?=$tableDroite["photo_equipe"]?>">
                    <?php
    ...
    <script>
        $(document).ready(function(){
            ...
            var ficheGauche = document.getElementsByClassName('gauche');

            for (var i = 0; i < ficheGauche.length; i++) 
            { 
                var elementDroit = document.getElementsByName(ficheGauche[i].name);
                var x = null;
                for (var j = 0; j < elementDroit.childNodes.length; j++)
                  {
                     if (elementDroit.childNodes[j].className == 'droite') 
                    {
                      x = elementDroit.childNodes[j];
                      break;
                    }
                  }


              alert(ficheGauche[i].name + ' ' + x.name)
            }
